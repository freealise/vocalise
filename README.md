...
<p><b>TODO:</b><br/>
- upgrade to general language learning app to complete the randomly missing words and phrases in word definitions for grammar (combine letters and phonemes, syllables, words, phrases and sentences) and common vocabulary (look up by word or several (in specific order or not), sentence construction by Google Cloud NL parser and Google Books Ngrams with several queries or DictionaryAPI examples / phrasebook / Sefaria multilingual)<br/>
