...
<p><b>TODO:</b><br/>
- upgrade to general language learning app to complete the randomly missing words and phrases in word definitions for interactive grammar understood by experience (read and write, hear and speak letters and phonemes, syllables and morphemes, words, phrases and sentences) and common vocabulary (look up by word or several (in specific order or not), phrase and sentence by Google Cloud NL parser and Google Books Ngrams / Phrasefinder with several queries)<br/>
