...
<p><b>TODO:</b><br/>
- library app containing grammar and common vocabulary (look up by word or several (in specific order or not), explicit / overused / repetitive word filter (and AI for quality control), sentence construction by Google Cloud NL or Compromise parser)<br/>
