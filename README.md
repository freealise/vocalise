...
<p><b>TODO:</b><br/>
- lyrics library app containing grammar and common vocabulary (look up by word or several (in specific order or not), explicit / overused / repetitive word filter (and AI for quality control), sentence construction by Compromise parser); is highlighting letters or phonemes with color a mnemonic device ?<br/>
