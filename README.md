...
<p><b>TODO:</b><br/>
- upgrade to general language learning app with example sentences from DictionaryAPI and folk songs library (where ?) to complete the randomly missing words and phrases for grammar and common vocabulary (look up by word or several (in specific order or not), sentence construction by Google Cloud NL parser)<br/>
