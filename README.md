...
<p><b>TODO:</b><br/>
- upgrade to general language learning app to complete the randomly missing words and phrases in word definitions for interactive grammar understood by experience (read and write, hear and speak letters and phonemes, syllables and morphemes, words, phrases and sentences) and common vocabulary (look up by word or several (in specific order or not), sentence construction by Google Cloud NL parser and Google Books Ngrams with several queries or DictionaryAPI examples / phrasebook / Sefaria multilingual in json (https://github.com/Sefaria/Sefaria-Export/blob/master/json/Tanakh/Torah/Genesis/English/))<br/>
